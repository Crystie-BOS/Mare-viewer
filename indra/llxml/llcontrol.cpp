      ...
      mSanityComment(sanityComment)
{
    if ((persist != PERSIST_NO) && mComment.empty())
    {
        std::string error_string =
            "Kokua failed to initialize settings. Setting " + mName + " is invalid. "
            "Either settings' files were supplied incorrectly or default files were corrupted."
            "\n\nPlease reinstall viewer from an official download location and "
            "seek assistance in the Kokua group if needed.";
