...
protected:
    ...
    void onClickCopy();
    void onClickPaste();
    void onClickDuplicateDiffuse();
    void onClickDuplicateNormal();
    void onClickDuplicateSpecular();
...
private:
    ...
    LLCheckBoxCtrl* mTexScaleFlipU { nullptr };
    LLCheckBoxCtrl* mTexScaleFlipV { nullptr };
    LLCheckBoxCtrl* mBumpyScaleFlipU { nullptr };
    LLCheckBoxCtrl* mBumpyScaleFlipV { nullptr };
    LLCheckBoxCtrl* mShinyScaleFlipU { nullptr };
    LLCheckBoxCtrl* mShinyScaleFlipV { nullptr };
    LLButton* mTexDuplicate { nullptr };
    LLButton* mBumpyDuplicate { nullptr };
    LLButton* mShinyDuplicate { nullptr };
