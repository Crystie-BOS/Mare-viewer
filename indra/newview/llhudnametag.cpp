...
{
	addLabelWithColorAndEmphasis(label_utf8, mColor, false, max_pixels);
}

void LLHUDNameTag::addLabelWithColorAndEmphasis(const std::string& label_utf8, const LLColor4& lColor, bool useBold, F32 max_pixels)
{
