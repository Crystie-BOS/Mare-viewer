...
void LLPipeline::toggleRenderType(U32 type)
{
    ...
    {
        if (!gAgent.mRRInterface.mGarbageCollectorCalledOnce && sHideAvatar && sUseStrict)
        {
...
{
/// RLV:PBR this is probably in the wrong place now
// [RLVa:KB] - @setsphere
...
//RLV:PBR This routine has changed beyond recognition - removing setsphere references for now
...
//MK
        ...
        glm::mat4 persp = glm::perspective(glm::radians(fov), aspect, 0.001f, 256.f);
//mk
...
// MK by CA
// actually visually_muted will be set if silhouette or too_complex is, however the rest of this code doesn't assume that, so...
