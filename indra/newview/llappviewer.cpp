...
//MK
					...
					&& !gViewerWindow->getShowProgress())
				{
					...
					//// Let's look at how much time has passed since the last change to the outfit
...
//MK 
//Constant release notes URL so retain the original code that doesn't include version number
