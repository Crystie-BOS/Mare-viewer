...
void LLIMModel::addMessage(const LLUUID& session_id, const std::string& from, const LLUUID& from_id, 
    ...
    {
        processAddingMessage(session_id, from, from_id, utf8_text, log2file, is_announcement, keyword_alert_performed, is_region_msg);
    }
}

void LLIMModel::processAddingMessage(const LLUUID& session_id, const std::string& from, const LLUUID& from_id,
    const std::string& utf8_text, bool log2file /* = true */, bool is_announcement /* = false */, bool keyword_alert_performed /* = false */, bool is_region_msg /* = false */)
{
