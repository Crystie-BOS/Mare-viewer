...
// [/SL:KB]
	...
	//KKA-827 Add lite inventory without recent/worn
	LLFloaterReg::add("inventory_lite", "floater_my_inventory_lite.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<LLFloaterSidePanelContainer>);
