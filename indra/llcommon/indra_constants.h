...
constexpr F32 CHAT_MAX_RADIUS = CHAT_SHOUT_RADIUS;
constexpr F32 CHAT_MAX_RADIUS_BY_TWO = CHAT_MAX_RADIUS / 2.f;

// squared editions of the above for distance checks

constexpr F32 CHAT_WHISPER_RADIUS_SQUARED = CHAT_WHISPER_RADIUS * CHAT_WHISPER_RADIUS;
constexpr F32 CHAT_NORMAL_RADIUS_SQUARED = CHAT_NORMAL_RADIUS * CHAT_NORMAL_RADIUS;
constexpr F32 CHAT_SHOUT_RADIUS_SQUARED = CHAT_SHOUT_RADIUS * CHAT_SHOUT_RADIUS;
constexpr F32 CHAT_MAX_RADIUS_SQUARED = CHAT_SHOUT_RADIUS_SQUARED;
constexpr F32 CHAT_MAX_RADIUS_BY_TWO_SQUARED = CHAT_MAX_RADIUS_BY_TWO * CHAT_MAX_RADIUS_BY_TWO;
...
constexpr U32 AGENT_CONTROL_MBUTTON_SCROLL_DOWN = 0x4 << CONTROL_LBUTTON_DOWN_INDEX;    // 0x20000000
constexpr U32 AGENT_CONTROL_MBUTTON_SCROLL_UP   = 0x4 << CONTROL_LBUTTON_UP_INDEX;      // 0x20000000
constexpr U32 AGENT_CONTROL_RBUTTON_DOWN        = 0x2 << CONTROL_LBUTTON_DOWN_INDEX;    // 0x20000000
constexpr U32 AGENT_CONTROL_RBUTTON_UP          = 0x2 << CONTROL_LBUTTON_UP_INDEX;      // 0x20000000
constexpr U32 AGENT_CONTROL_MBUTTON_DOWN        = 0x3 << CONTROL_LBUTTON_DOWN_INDEX;    // 0x20000000
constexpr U32 AGENT_CONTROL_MBUTTON_UP          = 0x3 << CONTROL_LBUTTON_UP_INDEX;      // 0x20000000
