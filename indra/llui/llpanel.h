...
public:
    ...
    const LLCallbackMap_map_t& getFactoryMap() const { return mFactoryMap; }
...
protected:
    ...
    LLCallbackMap_map_t mFactoryMap;
    ...
    typedef std::deque<const LLCallbackMap_map_t*> factory_stack_t;
